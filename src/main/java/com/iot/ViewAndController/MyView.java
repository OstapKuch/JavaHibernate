...
public class MyView {
    ...
    public MyView() {
        ...
        menu.put("1", "   1 - Table: AirbnbWallet");
        menu.put("11", "  11 - Create for AirbnbWallet");
        menu.put("12", "  12 - Update AirbnbWallet");
        menu.put("13", "  13 - Delete from AirbnbWallet");
        menu.put("14", "  14 - Select AirbnbWallet");
        menu.put("15", "  15 - Find AirbnbWallet by ID");
